...
public class CalculatorParser extends Parser {
	...
	public final AssignExpressionContext assignExpression() throws RecognitionException {
		...
		try {
			...
			match(ASSIGN);
			setState(21);
			((AssignExpressionContext)_localctx).ex = expression(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class AsgExprContext extends ExpressionContext {
		public AssignExpressionContext assignExpression() {
			return getRuleContext(AssignExpressionContext.class,0);
		}
		public AsgExprContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterAsgExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitAsgExpr(this);
		}
	}
	public static class IConstExprContext extends ExpressionContext {
		public Token i;
		public TerminalNode INTEGER() { return getToken(CalculatorParser.INTEGER, 0); }
		public IConstExprContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterIConstExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitIConstExpr(this);
		}
	}
	public static class BinaryArithExprContext extends ExpressionContext {
		...
		public BinaryArithExprContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterBinaryArithExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitBinaryArithExpr(this);
		}
	}
	...
	public static class UnaryNotExprContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterUnaryNotExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitUnaryNotExpr(this);
		}
	}
	public static class VariableExprContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterVariableExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitVariableExpr(this);
		}
	}
	...
	public static class BinaryRelExprContext extends ExpressionContext {
		public ExpressionContext left;
		public Token op;
		public ExpressionContext right;
		public List<ExpressionContext> expression() {
		...
		public BinaryRelExprContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterBinaryRelExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitBinaryRelExpr(this);
		}
	}
	public static class UnaryMinusExprContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterUnaryMinusExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitUnaryMinusExpr(this);
		}
	}
	public static class BConstExprContext extends ExpressionContext {
		public BooleanConstantContext booleanConstant() {
			return getRuleContext(BooleanConstantContext.class,0);
		}
		public BConstExprContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).enterBConstExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CalculatorListener ) ((CalculatorListener)listener).exitBConstExpr(this);
		}
	}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				match(LPAR);
				setState(25);
				((ParenExprContext)_localctx).ex = expression(0);
				setState(26);
				match(RPAR);
				}
				break;
			case 2:
				...
				setState(29);
				((UnaryMinusExprContext)_localctx).ex = expression(10);
				}
				break;
			case 3:
				{
				...
				_prevctx = _localctx;
				setState(30);
				((UnaryNotExprContext)_localctx).op = match(NOT);
				setState(31);
				((UnaryNotExprContext)_localctx).ex = expression(9);
				}
				break;
			case 4:
				{
				_localctx = new AsgExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(32);
				assignExpression();
			...
			case 5:
				{
				_localctx = new BConstExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(33);
				booleanConstant();
			...
			case 6:
				...
				_prevctx = _localctx;
				setState(34);
				((VariableExprContext)_localctx).v = match(VARIABLE);
				}
				break;
			case 7:
				{
				_localctx = new IConstExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(35);
				((IConstExprContext)_localctx).i = match(INTEGER);
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new BinaryArithExprContext(new ExpressionContext(_parentctx, _parentState));
						...
						setState(40);
						((BinaryArithExprContext)_localctx).right = expression(9);
						}
						break;
					case 2:
						{
						...
						setState(43);
						((BinaryArithExprContext)_localctx).right = expression(8);
						}
						break;
					case 3:
						{
						_localctx = new BinaryRelExprContext(new ExpressionContext(_parentctx, _parentState));
						((BinaryRelExprContext)_localctx).left = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expression);
						setState(44);
						if (!(precpred(_ctx, 6))) throw new FailedPredicateException(this, "precpred(_ctx, 6)");
						setState(45);
						((BinaryRelExprContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==GREATER || _la==LESS) ) {
							((BinaryRelExprContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
						...
						setState(46);
						((BinaryRelExprContext)_localctx).right = expression(7);
						}
						break;
					case 4:
						{
						...
						setState(49);
						((EqExprContext)_localctx).right = expression(5);
						}
						break;
					}
					} 
